...
[flycut]() | flycut is a clipboard manager tool for macOS and stores your copy history. It's based on an open source app called Jumpcut.
[Notion]() | A tool which provides more than just taking notes. Create new templates or choose templates from its library and track your work effectively.
| **Debug/Security** |
